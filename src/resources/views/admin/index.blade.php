...
<div ng-app="typicms" ng-cloak ng-controller="ListController" ng-show="!initializing">
    ...
    <h1>
        <span>@{{ totalModels }} @choice('news::global.news', 2)</span>
    </h1>
    ...
    <div class="table-responsive">
        <table st-persist="newsTable" st-table="displayedModels" st-order st-sort-default="date" st-sort-default-reverse="true" st-pipe="callServer" st-filter class="table table-condensed table-main">
            <thead>
                <tr>
